...
export const APIS = [EventDetailsService, EventTypeService, EventTypeOverviewService, GameDetailsService, GameOverviewService, PaymentService, PlayerService, RoundDetailsService, StatisticsService, UserService, WhatsappService];
